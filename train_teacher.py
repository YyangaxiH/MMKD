...
def run(args):
    ...
    if args.exp_setting == "tran":
        ...
        out_logits_hidden, out, score_val, score_test = run_transductive(
            conf,
            model,
            g,
            feats,
        ...
        out_logits_hidden, out, score_val, score_test_tran, score_test_ind = run_inductive(
            conf,
            model,
            g,
            feats,
